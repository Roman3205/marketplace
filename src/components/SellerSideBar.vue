  ...
  methods: {
    ...
    openBar(evt) {
      ...
      document.documentElement
        .querySelector(".router-seller")
        .classList.toggle("opener-sell");
    },
  ...
  <div class="container">
    <div class="wrapper">
      ...
      <div class="nav-container">
        <button
          class="btn"
          @click="goRoute($event, 'statistics')"
          :class="{
        ...
        <button
          class="btn"
          @click="goRoute($event, 'sellrefund')"
          :class="{
